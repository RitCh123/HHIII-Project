...
var ImgTile = function ImgTile2(_ref) {
...
var Map = function(_Component) {
  ...
  _proto.renderTiles = function renderTiles() {
    ...
    return import_react.default.createElement("div", {
      ...
      return import_react.default.createElement(Tile, {
        key: tile.key,
        tile,
  ...
  _proto.renderOverlays = function renderOverlays() {
    ...
    var childrenWithProps = import_react.default.Children.map(this.props.children, function(child) {
      if (!child) {
        return null;
      }
  ...
  _proto.renderAttribution = function renderAttribution() {
    ...
    return import_react.default.createElement("div", {
      ...
      style
    }, attributionPrefix === false ? null : import_react.default.createElement("span", null, attributionPrefix || import_react.default.createElement("a", {
      href: "https://pigeon-maps.js.org/",
      style: linkStyle,
      target: "_blank",
      rel: "noreferrer noopener"
    }, "Pigeon"), " | "), attribution || import_react.default.createElement("span", null, " \xA9 ", import_react.default.createElement("a", {
...
function Marker(props) {
  ...
  var _useState = (0, import_react.useState)(props.hover || false), internalHover = _useState[0], setInternalHover = _useState[1];
...
function PointComponent(props) {
  ...
  var _latLngToPixel = latLngToPixel([x, y]), cx = _latLngToPixel[0], cy = _latLngToPixel[1];
  return import_react.default.createElement("circle", _objectSpread2({
    cx,
    cy
  }, props.svgAttributes));
}
function MultiPoint(props) {
  return import_react.default.createElement(import_react.default.Fragment, null, props.coordinates.map(function(point, i) {
    return import_react.default.createElement(PointComponent, _objectSpread2(_objectSpread2({}, props), {}, {
      coordinates: point,
      key: i
    }));
  }));
...
function LineString(props) {
  ...
  var p = "M" + props.coordinates.reduce(function(a, _ref) {
    ...
    var _latLngToPixel2 = latLngToPixel([x, y]), v = _latLngToPixel2[0], w = _latLngToPixel2[1];
    return a + " " + v + " " + w;
  }, "");
  return import_react.default.createElement("path", _objectSpread2({
    d: p
  }, props.svgAttributes));
}
function MultiLineString(props) {
  return import_react.default.createElement(import_react.default.Fragment, null, props.coordinates.map(function(line, i) {
    return import_react.default.createElement(LineString, {
      coordinates: line,
      key: i
    });
  }));
...
function Polygon(props) {
  ...
  var p = props.coordinates.reduce(function(a, part) {
    return a + " M" + part.reduce(function(a2, _ref2) {
      var y = _ref2[0], x = _ref2[1];
      var _latLngToPixel3 = latLngToPixel([x, y]), v = _latLngToPixel3[0], w = _latLngToPixel3[1];
      return a2 + " " + v + " " + w;
    }, "") + "Z";
  }, "");
  return import_react.default.createElement("path", _objectSpread2({
...
function MultiPolygon(props) {
  return import_react.default.createElement(import_react.default.Fragment, null, props.coordinates.map(function(polygon, i) {
    return import_react.default.createElement(Polygon, _objectSpread2(_objectSpread2({}, props), {}, {
      coordinates: polygon,
      key: i
    }));
  }));
...
function GeometryCollection(props) {
  ...
  if (type === "GeometryCollection") {
    return import_react.default.createElement(import_react.default.Fragment, null, geometries.map(function(geometry, i) {
      return import_react.default.createElement(GeometryCollection, _objectSpread2(_objectSpread2({
        key: i
      }, props), {}, {
        geometry
      }));
  ...
  var Component2 = renderer[type];
  if (Component2 === void 0) {
    console.warn("The GeoJson Type " + type + " is not known");
    return null;
  }
  return import_react.default.createElement(Component2, {
...
function GeoJsonFeature(props) {
  var _useState = (0, import_react.useState)(props.hover || false), internalHover = _useState[0], setInternalHover = _useState[1];
  var hover = props.hover !== void 0 ? props.hover : internalHover;
  ...
  }, import_react.default.createElement(GeometryCollection, _objectSpread2(_objectSpread2(_objectSpread2({}, props), props.feature), {}, {
    svgAttributes
  })));
}
function GeoJson(props) {
  ...
  return import_react.default.createElement("div", {
    ...
    return import_react.default.createElement(GeoJsonFeature, _objectSpread2(_objectSpread2({
      key: i
    }, props), {}, {
      feature
    }));
  }), import_react.default.Children.map(props.children, function(child) {
    if (!child) {
      return null;
    }
    if (!import_react.default.isValidElement(child)) {
    ...
    return import_react.default.cloneElement(child, props);
  })));
}
function GeoJsonLoader(props) {
  var _useState2 = (0, import_react.useState)(props.data ? props.data : null), data = _useState2[0], setData = _useState2[1];
  ...
  return data ? import_react.default.createElement(GeoJson, _objectSpread2({
    data
  }, props)) : null;
}
...
function Draggable(props) {
  ...
  var stateRef = (0, import_react.useRef)(_objectSpread2({}, defaultState));
  var _useState = (0, import_react.useState)(defaultState), _state = _useState[0], _setState = _useState[1];
  propsRef.current = props;
  var setState = function setState2(stateUpdate) {
  ...
  (0, import_react.useEffect)(function() {
    ...
    var handleDragMove = function handleDragMove2(event) {
      ...
      var deltaX2 = x - stateRef.current.startX;
      var deltaY2 = y - stateRef.current.startY;
      setState({
        deltaX: deltaX2,
        deltaY: deltaY2
      });
      if (propsRef.current.onDragMove) {
        ...
        propsRef.current.onDragMove(pixelToLatLng([_startLeft + deltaX2 + (offset ? offset[0] : 0), _startTop + deltaY2 + (offset ? offset[1] : 0)]));
      }
    };
    var handleDragEnd = function handleDragEnd2(event) {
      ...
      var _stateRef$current2 = stateRef.current, deltaX2 = _stateRef$current2.deltaX, deltaY2 = _stateRef$current2.deltaY, startLeft2 = _stateRef$current2.startLeft, startTop2 = _stateRef$current2.startTop;
      (_propsRef$current$onD = (_propsRef$current4 = propsRef.current).onDragEnd) === null || _propsRef$current$onD === void 0 ? void 0 : _propsRef$current$onD.call(_propsRef$current4, pixelToLatLng([startLeft2 + deltaX2 + (offset ? offset[0] : 0), startTop2 + deltaY2 + (offset ? offset[1] : 0)]));
      setState({
        isDragging: false,
        startX: void 0,
        startY: void 0,
    ...
    var wa = function wa2(e, t, o) {
      return window.addEventListener(e, t, o);
    };
    var wr = function wr2(e, t) {
...
//# sourceMappingURL=pigeon-maps.js.map
